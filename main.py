...
class Fichar():
    ...
    def interfaz(self):#pantalla interfaz principal
      ...
      self.boton1=Button(self.raiz,text="FICHAR",bg="#3ADF00", height=2 ,font=('italic',10),width=30,activebackground="#FA2821",command=f.captura).place(x=75,y=80)
      Label(self.raiz, text="").pack()
      Label(self.raiz,text=self.d,font=("Helvetica", 11), foreground="blue").place(x=200,y=240)
      Label(self.raiz,text='Emoji del Trabajador',font=("Helvetica", 14,'underline')).place(x=200,y=270)
